...
<pre>
	...
	2)Умение работать с реаляционными базами данных на базовом уровне.
	3)Работа с Entity Framework на базовом уровне.
	4)Работа с Windows Forms. 
	5)Знание паттернов програмирования SOLID и их регулярное соблюдение.
	6)Понимание ООП.
	7)Опыт работы с криптографическими алгоритмами на базовом уровне.
</pre>
